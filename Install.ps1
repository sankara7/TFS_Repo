...
if (!(Test-Path c:\ManageEngine32.exe)) {

$WebClient = New-Object System.Net.WebClient
$WebClient.DownloadFile("https://www.manageengine.com/cgi-bin/download_exe?id=1-33","C:\ManageEngine32.exe")
...
Start-Process "C:\ManageEngine32.exe" -ArgumentList "/s /a /s /sms /f1c:\param.iss" -Wait -NoNewWindow
